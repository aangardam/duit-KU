      ...
      <div className="min-h-screen bg-background p-6">
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">Easily manage your expenses and budget</p>
          </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">
                      Rp {totalBalance ? formatRupiah(`${totalBalance}`) : 0}
                    </p>
                  </div>
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold text-foreground">My Wallets</h2>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-2xl font-semibold text-foreground">Budget vs Actual</h2>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">
                  ...
                  (Rp {totalSalary ? formatRupiah(`${totalSalary}`) : 0})
                </CardTitle>
              </CardHeader>
              <CardContent>
                    ...
                    return (
                      <div key={index} className="space-y-3">
                        ...
                        <div className="grid grid-cols-3 gap-4 text-sm">
                          ...
                          <div>
                            <p className="text-muted-foreground">Remaining/Difference</p>
                            <p
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between text-xs text-muted-foreground">
                            ...
                            <span>
                              Rp {formatRupiah(`${item.total_expense}`)} /{" "}
